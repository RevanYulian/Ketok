...
class AppConfig {
  ...
  factory AppConfig.fromMap(Map<String, dynamic> map) {
    ...
    return AppConfig(
      namaAplikasi: map['nama_aplikasi'] as String? ?? 'Ketok Mitra',
...
class AppConfigService {
  ...
  Future<void> loadConfig() async {
    try {
      ...
      debugPrint('Error loading mitra app config: $e');
    }
  }
  ...
  void subscribeConfig() {
    try {
      ...
      _subscription = client
          .channel('public:pengaturan_aplikasi:ketok_mitra')
          .onPostgresChanges(
            event: PostgresChangeEvent.all,
            schema: 'public',
            table: 'pengaturan_aplikasi',
            callback: (payload) {
              debugPrint('Realtime config change detected for ketok_mitra');
              final newRecord = payload.newRecord;
              if (newRecord.isNotEmpty && newRecord['tipe_app'] == 'ketok_mitra') {
      ...
      debugPrint('Error subscribing to mitra app config: $e');
    }
  }
}
